...
def add_admin():
    ...
    try:
        ...
        if not otp_secret:
            print
            print "If the barcode below does not render correctly, try changing your terminal's font, (Monospace for Linux, Menlo for OS X)."
            ...
            print
            print "If you can't scan the barcode below enter following shared secret manually:"
